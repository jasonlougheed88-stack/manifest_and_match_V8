...
let testJobs: [TestJob] = [
    ...
    TestJob(
        ...
        source: "indeed",
        url: nil,
        expectedURL: "https://www.indeed.com/jobs?q=Senior%20iOS%20Developer%20TestCompany1&l=Cupertino,%20CA"
    ),
    ...
    TestJob(
        ...
        source: "linkedin",
        url: nil,
        expectedURL: "https://www.linkedin.com/jobs/search/?keywords=Software%20Engineer%20TestCompany2"
    ),
    ...
    TestJob(
        ...
        source: "greenhouse",
        url: "https://careers.testcompany3.com/jobs/results/142434234",
        expectedURL: "https://careers.testcompany3.com/jobs/results/142434234"
    ),
    ...
    TestJob(
        ...
        source: "glassdoor",
        url: nil,
        expectedURL: "https://www.glassdoor.com/Jobs/TestCompany4-Jobs-ETestCompany4.htm"
    ),
    ...
    TestJob(
        ...
        source: "unknown",
        url: nil,
        expectedURL: "https://www.testcompany5.com/careers"
    ),
